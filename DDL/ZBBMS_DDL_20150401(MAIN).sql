...
DROP TABLE T_MT_ITEM;
--zbbms@20150401 drop table - END

--zbbms@20150401 create item table - START
CREATE TABLE T_MT_ITEM (
ID VARCHAR2(32),
PRODUCT_ID VARCHAR2(32),
CD VARCHAR2(4) CONSTRAINT NN_ITEM_CD NOT NULL,
CONSTRAINT PK_ITEM_ID PRIMARY KEY(ID),
CONSTRAINT UK_ITEM_CD UNIQUE(CD)
);
--zbbms@20150401 create item table - END

--zbbms@20150401 create transaction type table - START
CREATE TABLE T_MT_TRANTYPE (
ID VARCHAR2(32),
NAME VARCHAR2(30),
CD VARCHAR2(4) CONSTRAINT NN_TRANTYPE_CD NOT NULL,
...
ID VARCHAR2(32),
NAME VARCHAR2(30),
CD VARCHAR2(4) CONSTRAINT NN_SPTYPE_CD NOT NULL,
...
SUPPID VARCHAR2(32),
ADDRESS VARCHAR2(80),
CD VARCHAR2(4) CONSTRAINT NN_SUPPLIER_CD NOT NULL,
...
ID VARCHAR2(32),
NAME VARCHAR2(30),
CD VARCHAR2(4) CONSTRAINT NN_BKTYPE_CD NOT NULL,
...
ID VARCHAR2(32),
NAME VARCHAR2(30),
CD VARCHAR2(4) CONSTRAINT NN_STTYPE_CD NOT NULL,
...
PRICE NUMBER(5,2),
STOCK NUMBER,
CD VARCHAR2(4) CONSTRAINT NN_STATIO_CD NOT NULL,
...
EMAIL VARCHAR2(30),             
WEBSITE VARCHAR2(30),
CD VARCHAR2(4) CONSTRAINT NN_PUBLI_CD NOT NULL, 
...
PHONE VARCHAR2(10), 
EMAIL VARCHAR2(30),             
CD VARCHAR2(4) CONSTRAINT NN_AUTHOR_CD NOT NULL, 
...
PRICE NUMBER(5,2),
STOCK NUMBER,
CD VARCHAR2(4) CONSTRAINT NN_BK_CD NOT NULL,
...
ID VARCHAR2(32),
ROLE VARCHAR2(30),
CD VARCHAR2(4) CONSTRAINT NN_ROLE_CD NOT NULL,
...
ROLE_ID VARCHAR2(32),
CD VARCHAR2(4) CONSTRAINT NN_EMP_CD NOT NULL,
...
CD VARCHAR2(4) CONSTRAINT NN_CUST_CD NOT NULL,
CONSTRAINT PK_CUST_ID PRIMARY KEY(ID),
CONSTRAINT UK_CUST_USERNAME UNIQUE(USERNAME),
...
CD VARCHAR2(4) CONSTRAINT NN_DISC_CD NOT NULL,
...
CD VARCHAR2(4) CONSTRAINT NN_TRAN_CD NOT NULL,
...
CONSTRAINT FK_BKTRAN_ITEM FOREIGN KEY (ITEM_ID) REFERENCES T_MT_ITEM(ID),
